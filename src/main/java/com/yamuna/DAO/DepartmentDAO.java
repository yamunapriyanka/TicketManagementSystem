...
public class DepartmentDAO {public class UserInfoDAO {private final JdbcTemplate jdbcTemplate = ConnectionUtil.getJdbcTemplate();
...
public List<Department> list() {
	final String sql = "select ID,NAME,ISACTIVE from DEPARTMENT";
