...
public class TestCreateTicketDAO {
	...
	public static void main(String[] args) throws  ServiceException, PersistantException {
       ...
       // String subject="LOGIN FAULT";
		//String description="mouse NOT WORKING";
	...
	//createTicket.findUserDetails(user.getEmailId(),user.getPassword());
		...
		//createTicket.assignEmployee(employee.getEmailId(), employee.getPassword(), issueId,employeeId);
		//createTicket.ticketSolution(employee.getEmailId(), employee.getPassword(), issueId, solution.getsolutionDescription());
